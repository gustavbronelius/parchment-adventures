...
from frontend.processing_label import ProcessingLabel
...
class GameGUI:
    ...
    def create_widgets(self):
        ...
        narrator = Narrator(self, history_manager)
    ...
    def create_game_logic(self):
        history_manager = HistoryManager()
        self.narrator = Narrator(self, history_manager)
        game_state_manager = GameStateManager(history_manager)
        return GameLogic(history_manager, self.narrator, game_state_manager, self.items_gui, self.quests_gui, self)
